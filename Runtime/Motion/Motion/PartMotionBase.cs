...
namespace NonsensicalKit.DigitalTwin.Motion
{
    ...
    public abstract class PartMotionBase : NonsensicalMono
    {
        ...
        {
            Publish<string, Action<List<PointData>>>("addPartListener", m_partID, OnReceiveData);
        }
        ...
        {
            Publish<string, Action<List<PointData>>>("removePartListener", m_partID, OnReceiveData);
        }
    }
    ...
    public class PLCPointInfo
    {
        ...
        public PLCPointInfo(string pointName, PointDataType type, bool isInput)
        {
